...
class ListaComidaCarrinhoAdapter(
    private val context: Context,
    private val activity: FragmentActivity?) : RecyclerView.Adapter<ListaComidaCarrinhoAdapter.MyViewHolder>() {

    private var res_room: List<Prato> = mutableListOf()

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): MyViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_carrinho, p0, false)
